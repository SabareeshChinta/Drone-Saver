# Drone Saver — AI Digital Twin Mission Diagnostic Report: `flight_01_healthy`
...
| **Primary Detected Fault Class** | `FT-01_SPARK_PLUG_FOULING` | ⚠️ ACTIVE |
| **Isolated Faulty Cylinder** | `Cylinder #2` (0 = Global Engine) | ⚠️ ISOLATED |
| **Predicted Remaining Useful Life** | `10.0 flight minutes` | ⚠️ CRITICAL |
...
![Digital Twin Timeline Dashboard](flight_01_healthy_digital_twin_dashboard.png)